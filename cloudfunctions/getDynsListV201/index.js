...
exports.main = async (event, context) => {
    ...
    console.log(`[getDynsListV201 v${VERSION}] 环境初始化完成 - envId: ${envId}, event.envId: ${event.envId}`);
    console.log(`[getDynsListV201] 排查 实际选库 envId: ${envId} (test 前缀=测试库, prod 前缀=正式库)`);
    let {
        openId,
        type,
        verifyStatus,
